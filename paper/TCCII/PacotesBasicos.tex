...
% Renomeia o título do "bloco" flutuante
\floatname{algorithm}{Algoritmo}

% Renomeia os comandos do "algpseudocode"
...
\algrenewcommand\algorithmicfor{\textbf{Para}} % Específico para o \EndFor
\algrenewcommand\algorithmicdo{\textbf{Faça}}
\algrenewcommand\algorithmiccomment[1]{\textit{// #1}} % Muda o estilo do comentário (opcional)
\usepackage{amssymb}							% Pacote matemático
\usepackage{amsfonts}							% Pacote matemático
\usepackage{tocloft}                            % Pacote de formatação de lista de equações
