...
% -----------------------------------------------------------------
\titulo{Otimização de balanceadores de carga de sistemas de distribuição
de conteúdo por meio de monitoramento sistemático de memória}%

\autor{Pedro {}Faria Fernandes}%
...
\instituicao{Universidade do Estado de Santa Catarina, Centro de Ciências Tecnológicas, Bacharelado em Ciência da Computação - BCC}%
...
\include{./Textuais/1-Introducao/main}
\include{./Textuais/2-FundamentacaoTeorica/main}
\include{./Textuais/3-Proposta/main}
\include{./Textuais/4-Implementacao/main}
\include{./Textuais/5-ExperimentosEResultados/main}
\include{./Textuais/6-Conclusao/main}
...
\bibliographystyle{referencias.bst}	
