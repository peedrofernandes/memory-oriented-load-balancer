...
\begin{frame}{Trabalhos Relacionados (Parte 1)}
    ...
    \begin{tabular}{|p{0.22\textwidth}|p{0.35\textwidth}|p{0.35\textwidth}|}
        ...
        Não usa métricas de \textbf{consumo de memória} e leitura de disco para decisões de roteamento. \\
        \hline
...
\begin{frame}{Trabalhos Relacionados (Parte 2)}
    ...
    \begin{tabular}{|p{0.22\textwidth}|p{0.35\textwidth}|p{0.35\textwidth}|}
        ...
        \hline
        Sistema de replicação de conteúdo dinâmico \cite{dynamicLoadBalancingForEfficientVideoStreamingService2015} &
        ...
        Mede carga apenas por número de streams; ignora uso real de \textbf{memória} taxa de leitura de disco. \\
        \hline
    \end{tabular}
\end{frame}
